COURSE_ACTS(COURSE_BOB, _(" 1 GAZA"),
       _("BIG NETANYAHU")     , _("FOOTRACE WITH ALEX ROBAR THE QUICK") , _("SHOOT AT INNOCENT PALESTINIANS"),
       _("FIND THE 8 RED COURT APPEALS")          , _("MARIO SOARS TO AGARTHA")        , _("BEHIND FAT NIGGA'S GATE"))
